...
const server = http.createServer((req, res) => {
  ...
  if (urlMethod === "GET") {
    switch (urlPathName) {
      ...
      case "/paging.js":
        serverReadFileModule(res, "paging.js", "text/javascript", 200);
        // res.writeHead(302, { Location: "/print" });
        // res.end();
        break;

      case "/recipe_ingredients_table.json":
      ...
      //레시피 리스트
      case "/recipe_list":
        serverReadFileModule(res, "recipe_list.html", "text/html", 200);
        break;
      case "/recipe_list.js":
        serverReadFileModule(res, "recipe_list.js", "text/javascript", 200);
        break;
